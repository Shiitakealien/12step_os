...
void kz_syscall(kz_syscall_type_t type, kz_syscall_param_t *pram);
void kz_srvcall(kz_syscall_type_t type, kz_syscall_param_t *pram);

/* system task */
int consdrv_main(int ragc, char *argv[]);
